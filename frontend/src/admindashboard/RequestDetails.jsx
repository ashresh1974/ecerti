...
function RequestDetails() {
  ...
  const fetchDetails = useCallback(() => {
    axios.get(`${process.env.REACT_APP_BACKEND_URL || "http://localhost:5000"}/api/certificate/details/${reference_num}`, { withCredentials: true })
      .then(res => {
  ...
  const fetchTemplates = useCallback(() => {
    axios.get('${process.env.REACT_APP_BACKEND_URL || "http://localhost:5000"}/api/templates/', { withCredentials: true })
      .then(res => {
  ...
  const handleApprove = async () => {
    ...
    try {
      await axios.post(
        `${process.env.REACT_APP_BACKEND_URL || "http://localhost:5000"}/api/certificate/approve/${reference_num}`,
  ...
  const handleReject = async () => {
    ...
    try {
      ...
      await axios.post(`${process.env.REACT_APP_BACKEND_URL || "http://localhost:5000"}/api/certificate/reject/${reference_num}`, { remark: finalReason }, { withCredentials: true });
